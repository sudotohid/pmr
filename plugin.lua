function run(msg)
	...
	about_key = {{{text = "تیم سناتور" , url = "https://telegram.me/senator_tea"}},{{text = "سازنده پیام رسان" , url = "https://telegram.me/Lv_t_m"}}}
	start_txt = "سلام دوست عزيز\n\n`از طریق این ربات حتی اگر ریپورت باشی هم میتونی با من چت کنی. این ربات قابلیت های دیگه ای هم داره که از کیبرد زیر میتونی بهشون دست پیدا کنی. اگر از این ربات پیشرفته ی پیام رسان نیاز داری، روی کلید زیر کلیک کن. این ربات رایگان نیست و توسط تیم قدرتمند سناتور طراحی و ساخته شده.`"
	start_key = {{{text="ساخت ربات پیام رسان",url="https://telegram.me/Sudosenator_bot"}}}
...
function inline(msg)
	...
	bioinfo = infotxtin.."*Name:* "..sudo_name.."\n*Username:* [@"..sudo_user.."](https://telegram.me/"..sudo_user..")\n*Mobile:* +"..sudo_num.."\n*Telegram ID:* "..sudo_id.."\n*Channel:* [@"..sudo_ch.."](https://telegram.me/"..sudo_ch..")\n\n_Powered by_ [senator](https://telegram.me/senator_tea)"
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/senator_tea"},{"text":"سازنده ربات","url":"https://telegram.me/Lv_t_m"}]'
